...
namespace USC.GISResearchLab.Common.Addresses
{
    ...
    public class StreetAddress : AbstractStreetAddress
    {
        ...
        public StreetAddress(string number, string numberFractional, string preDirectional, string preQualifier, string preType, string preArticle, string name, string suffix, string postArticle, string postQualifier, string postDirectional, string suite, string suiteNumber, string city, string state, string zip, string country)
        {
            ...
            NumberFractional = (!String.IsNullOrEmpty(numberFractional)) ? numberFractional.Trim() : null;
            PreDirectional = (!String.IsNullOrEmpty(preDirectional)) ? preDirectional.Trim() : null;
            PreType = (!String.IsNullOrEmpty(preType)) ? preType.Trim() : null;
            PreQualifier = (!String.IsNullOrEmpty(preQualifier)) ? preQualifier.Trim() : null;
            PreArticle = (!String.IsNullOrEmpty(preArticle)) ? preArticle.Trim() : null;
            StreetName = (!String.IsNullOrEmpty(name)) ? name.Trim() : null;
            Suffix = (!String.IsNullOrEmpty(suffix)) ? suffix.Trim() : null;
            PostArticle = (!String.IsNullOrEmpty(postDirectional)) ? postDirectional.Trim() : null;
            PostDirectional = (!String.IsNullOrEmpty(postArticle)) ? postArticle.Trim() : null;
            PostQualifier = (!String.IsNullOrEmpty(postQualifier)) ? postQualifier.Trim() : null;
